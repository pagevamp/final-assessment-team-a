...
const styleFiles = fs.readdirSync(
  path.resolve(__dirname, "resources", "styles", "styles"),
  "utf-8"
)

const scriptFiles = fs.readdirSync(
  path.resolve(__dirname, "resources", "scripts", "modules"),
  "utf-8"
)
...
mix.setPublicPath("./public").browserSync("wordpress-boilerplate-trainee.local")
