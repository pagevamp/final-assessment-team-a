...
if (!empty($capabilities)):
    ...
    $mobile_image       = $capabilities['mobile_image'] ?? '';
?>

    <?php if (!empty($mobile_image)): ?>
        <figure class="capabilities__image-container d-sm-none">
            <img class="w-100 h-100 object-fit-cover" src="<?php echo $mobile_image['url']; ?>" alt="<?php echo $mobile_image['alt']; ?>">
        </figure>
    <?php endif; ?>
