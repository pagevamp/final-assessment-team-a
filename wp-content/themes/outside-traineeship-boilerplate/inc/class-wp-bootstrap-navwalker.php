...
if (! class_exists('WP_Bootstrap_Navwalker')) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu
	{
		...
		public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
		{
			...
			/**
			 * Replace the dropdown icon with custom icon.
			 */
			$icon_dropdown = '';
			if (isset($args->has_children) && $args->has_children && 0 === $depth) {
				// Replace this with the custom icon you want to use.
				$icon_dropdown = '<span class="icon-chevron-down"></span> ';
			}

			// Put the item contents into $output.
			$item_output .= isset($args->link_before) ? $args->link_before . $icon_html . $title . $args->link_after . $icon_dropdown  : '';
			/**
